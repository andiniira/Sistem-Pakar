                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-list fa"></span> Gejala
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-list fa"></span> Penyakit
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-list fa"></span> Pencegahan
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="pencegahan.php">Data Pencegahan</a></li>
                      </ul>
                    </li>
                    
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-list fa"></span> Solusi
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-list fa"></span> Rule
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="rule.php">Rule Kondisi</a></li>
                      </ul>
                    </li>
                    
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-user fa"></span> Admin
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
